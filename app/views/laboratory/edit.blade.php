...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ URL::to('laboratorium') }}/{{ $laboratory->id }}/edit"><i class="active"></i> Pendaftaran #{{ $laboratory->code }}</a></li>
    </ol>
</section>

<section class="content">
    <div class="row">
        @if($laboratory->registration_type == 'Patient')
        <div class="col-lg-6">
            <input type="radio" name="patient" value="patient" checked>&nbsp;&nbsp;&nbsp;<strong class="text-info">Pasien Biasa</strong>
        </div>
        @else
        <div class="col-lg-6">
            <div class="pull-right">
                <input type="radio" name="patient" value="office" checked>&nbsp;&nbsp;&nbsp;<strong class="text-info">Kantor/Instansi</strong>
            </div>
        </div>
        @endif
    </div>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            @if($laboratory->recommender == "1")
                                <input type="radio" name="recommender" value="{{ $laboratory->recommender }}">&nbsp;&nbsp;Dokter&nbsp;&nbsp;&nbsp;
                            @elseif($laboratory->recommender == "2")
                                <input type="radio" name="recommender" value="{{ $laboratory->recommender }}">&nbsp;&nbsp;Institusi&nbsp;&nbsp;&nbsp;
                            @elseif($laboratory->recommender == "3")
                                <input type="radio" name="recommender" value="{{ $laboratory->recommender }}" checked>&nbsp;&nbsp;Pasien/Kantor
                            @endif
                        </div>
                        <div class="col-md-6">
                            <label for="recommender">Masukkan Nama Pengirim</label><br/>
                            <input type="text" id="recommender_name" name="recommender_name" class="form-control input-sm" value="{{ $laboratory->recommender_name }}" disabled>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-12">
            <div class="box box-primary">
                <div class="box-header">
                    <div class="pull-right box-tools"><button id="btn-save-patient" onclick="createPatient()" class="btn btn-flat btn-primary" data-toggle="tooltip" data-placement="left" title="Simpan Pasien Baru" disabled><i class="fa fa-floppy-o"></i></button></div>
    ...
    @if($laboratory->registrant_type == "Office")
