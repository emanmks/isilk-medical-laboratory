...
<section class="content invoice">
    ...
    <div class="row no-print">
        <div class="col-lg-8 col-lg-offset-4">
            <form class="form-inline" method="POST" action="{{ URL::to('laporan/pemeriksaan') }}">
    ...
    <div class="row invoice-info">
        ...
        <div class="col-lg-6">
           	<p class="text-center">
           		<strong><u>LAPORAN SEMUA PEMERIKSAAN</u></strong><br/>
                ...
                <tbody>
                    @foreach($laboratories->getCollection() as $laboratory)
                        <tr>
                            ...
                            <td>{{ date('d-m-Y', strtotime($laboratory->registrationtime)) }}</td>
...
<script type="text/javascript">
	$(function(){
        ...
        $('#filterPeriods').data('daterangepicker').setStartDate("{{ $from }}");
        $('#filterPeriods').data('daterangepicker').setEndDate("{{ $to }}");
    });
</script>
@stop