...
<section class="content invoice">
    ...
    <div class="row no-print">
        <div class="col-lg-8 col-lg-offset-4">
            <form class="form-inline" method="POST" action="{{ URL::to('laporan/pemeriksaan/instansi') }}">
    ...
    <div class="row invoice-info">
        ...
        <div class="col-lg-6">
           	<p class="text-center">
           		<strong><u>LAPORAN PEMERIKSAAN INSTANSI</u></strong><br/>
                ...
                <tbody>
                    @foreach($laboratories->getCollection() as $laboratory)
                        <tr>
                            ...
                            <td>{{ $laboratory->registrant->fax or '' }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>                            
